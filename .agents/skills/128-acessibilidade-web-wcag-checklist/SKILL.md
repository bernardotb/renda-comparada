---
name: 128-acessibilidade-web-wcag-checklist
description: Audita acessibilidade da interface web do Renda Comparada quando a tarefa envolver semântica, teclado, foco, contraste, formulários, mensagens ou compatibilidade com tecnologias assistivas.
---
...
4. Implemente correções somente quando a tarefa autorizar edição; caso contrário, entregue apenas a auditoria e propostas de código
...
Tipo: E-commerce (listagem de produtos + checkout)Stack: React + Tailwind CSSProblemas conhecidos: botões sem label, imagens sem alt, formulário difícil com leitor de tela
...
<button class="bg-blue-500 p-2" onclick="addToCart(id)">  <svg>…</svg></button>

<!-- DEPOIS (acessível) -->

<button class="bg-blue-500 p-2" onclick="addToCart(id)" aria-label="Adicionar Camiseta Básica ao carrinho">
...
<img src="/produto/camiseta.jpg">

<!-- DEPOIS -->

<img src="/produto/camiseta.jpg" alt="Camiseta básica azul-marinho">
