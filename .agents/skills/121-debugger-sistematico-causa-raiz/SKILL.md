---
name: 121-debugger-sistematico-causa-raiz
description: Investiga bugs no Renda Comparada por reprodução, isolamento e evidência, especialmente em cálculos, dados, pipelines, frontend e divergências entre runtime e contratos canônicos.
---
...
Stack: Next.js + Node.js + PostgreSQLBug: Página de checkout mostra preço errado para 5% dos usuáriosEsperado: Preço do carrinho = soma dos itensReal: Às vezes o total é menor que a soma dos itensFrequência: Intermitente, mais comum em horários de picoJá tentei: Limpar cache, verificar cálculo no frontend
